...
- safety-critical escalation path (fall-hazard, weather-condition and crew-fatigue concerns always reach a human)
...
directly finalize a roofing-work-execution decision or override a
site-safety officer's fall-protection judgment — the governor's
...
humans, and that no integration allows this actor to finalize roofing
work or override site-safety authority.
